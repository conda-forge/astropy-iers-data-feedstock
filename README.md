About astropy-iers-data-feedstock
=================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/astropy-iers-data-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/astropy-iers-data-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add astropy-iers-data
# for installing globally
pixi global install astropy-iers-data
```
...
It is possible to list all of the versions of `astropy-iers-data` available on your platform:
...
```
pixi search astropy-iers-data --channel conda-forge
```
